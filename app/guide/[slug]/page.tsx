...
export default async function GuidePage({ params }: Props) {
  ...
  const articleSchema = { "@context": "https://schema.org", "@type": "Article", headline: title, description: detail.lead, inLanguage: "ko-KR", mainEntityOfPage: `${SITE_URL}/guide/${slug}`, author: { "@type": "Organization", name: "올바른청소", url: SITE_URL }, publisher: { "@type": "Organization", name: "올바른청소", url: SITE_URL } };
