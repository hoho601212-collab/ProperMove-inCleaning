...
import RegionalReviewMarquee from "@/components/RegionalReviewMarquee";
...
export default async function RegionPage({ params }: Props) {
  ...
  const imagePath = getRegionImagePath(region.slug);
  const showSeoulServiceBlocks = sido === "seoul" && (sigungu === "gangnam" || sigungu === "songpa");
  ...
  return <>
    ...
    {showSeoulServiceBlocks && <><SpecialReasons /><SpaceCleaningServices /></>}
    <RegionalReviewMarquee />
